...
def DisplayMenu():
    ...
    time.sleep(0.01)
    print("2"+("REMOVE A FILM").rjust(40,"-"))
    time.sleep(0.01)
    print("3"+("VIEW YOUR DATA").rjust(40,"-"))
    time.sleep(0.01)
    print("4"+("""TOTAL RUNTIME""").rjust(40,"-"))
    time.sleep(0.01)
    print("5"+("SAVE AND QUIT").rjust(40,"-"))
    time.sleep(0.01)
    print("6"+("TOP 30 ACTORS AND DIRECTORS").rjust(40,"-"))
    time.sleep(0.01)
    print("7"+("""FIND FILMS WITH X IN""").rjust(40,"-"))
    time.sleep(0.01)
    print("8"+("""TOP COMPOSERS""").rjust(40,"-"))
    time.sleep(0.01)
    print("9"+("""TOP GENRES""").rjust(40,"-"))
    time.sleep(0.01)
    print("10"+("""BY RATING""").rjust(39,"-"))
    time.sleep(0.01)
    print("11"+("""BY RELEASE YEAR""").rjust(39,"-"))
    time.sleep(0.01)
    print("12"+("""YOUR BEST ACTORS""").rjust(39,"-"))
    time.sleep(0.01)
    print("13"+("""GRAPH""").rjust(39,"-"))
    time.sleep(0.01)
    print("14"+("""FIND FILMS WITH COMPOSER X""").rjust(39,"-"))
    time.sleep(0.01)
    print("15"+("""TOP FILMS BY GENRE""").rjust(39,"-"))
    time.sleep(0.01)
    print("16"+("""TOP FILMS BY YEAR""").rjust(39,"-"))
    time.sleep(0.01)
    print("\n")
    print("\n")
    ValidInput = False
    while ValidInput == False:
        ...
        if Choice == "1":
            ...
            for film in ListOfFilms:
                if film == DeleteFilm:
                    Position = ChronilogicalOrder.index(DeleteFilm)
                    string = (IDList[Position])
                    del FilmCast[string]
                    del DateList[Position]
                    del RunTimes[Position]
                    del Ratings[Position]
                    del releaseYear[Position]
                    del Composers[Position]
                    print(IDList[Position])
                    id = IDList[Position]
                    RemoveMovieInfo(id)
                    del IDList[Position]
                    del Genres[id]
                    ListOfFilms.remove(DeleteFilm)
                    ChronilogicalOrder.remove(DeleteFilm)
                    FilmDeleted = True
            if FilmDeleted == False:
                print("This film is not in your list")
            print("\n")
            DisplayMenu()
        elif Choice == "5":
            ValidInput = True
...
def DisplayData():
    ...
    if MaxStringLength < 20:
        MaxStringLength = 20
    String = ("%-4s %-"+str(MaxStringLength)+"s %-13"+"s %-"+str(MaxStringLength)+"s")
...
def RemoveMovieInfo(id):
    ...
    if id != "N/A":
        ...
        RunTime = int(RunTime) - int(MovieRunTime)
